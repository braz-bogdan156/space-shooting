...
export function addNextLevelButton(app, endText) {
    ...
    nextLevelButtonText.x = nextLevelButton.width / 2 - nextLevelButtonText.width / 2; // Центруємо текст
    nextLevelButtonText.y = nextLevelButton.height / 2 - nextLevelButtonText.height / 2; // Центруємо текст
